...
public class GuiControllerSelectTest extends GuiControllerTest {
  ...
  public void testSelectCalendar() {
    ...
    controller.actionPerformed(new ActionEvent(this, 0, "select-calendar"));
    assertEquals("School", guiCalendar.getName());
    assertEquals("America/Los_Angeles", guiCalendar.getZoneId());
    ...
    controller.actionPerformed(new ActionEvent(this, 0, "select-calendar"));
    assertEquals("Default Calendar2", guiCalendar.getName());
    assertEquals("Africa/Nairobi", guiCalendar.getZoneId());
  }
  ...
  public void testInvalidCreateCalendar() {
    ...
    view.selectedCalendar = "School";
    controller.actionPerformed(new ActionEvent(this, 0, "select-calendar"));
    assertEquals("Error selecting: Calendar "
        + "'School' not found", view.lastError);
  }
}
